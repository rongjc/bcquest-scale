  ...
  it("Storage", () => {
    ...
    cy
      ...
      .should(() => {
        ...
        expect(reserve.tokens[0].addr).to.eq(
          "0x7CB654474CE963dFe68Fc26af5Bc9717e3380751"
        );
        expect(reserve.tokens[0].val).to.eq("500");
        expect(reserve.tokens[1].addr).to.eq(
          "0x9D82fEC2d59da5F1F38C285Ed7407F5D73900fD4"
        );
