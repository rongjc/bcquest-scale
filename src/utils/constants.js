...
export const VALIDATION_MESSAGES = {
  ...
  TICKER:
    'Please enter a valid Ticker that is less or equal than five characters',
  ...
  MULTIPLE_TIERS_START_TIME:
    'Please enter a valid date not less than the end time of the previous tier',
  EDITED_END_TIME:
    'Please enter a valid date later than start time and previous than start time of next tier',
  EDITED_START_TIME:
...
export const FILE_CONTENTS = {
  ...
  files: {
    ...
    safeMathLib: {
      ...
      txt: [
        {
          value: 'SafeMathLib library name: ',
          parent: 'none',
          fileValue: 'SafeMathLibExt'
        },
        {
          field: 'addr',
          value: 'SafeMathLib library address: ',
          parent: 'contracts',
          child: 'safeMathLib'
        },
        {
        ...
        {
          field: 'abi',
          value: '****SafeMathLib contract ABI:**** \n\n',
          parent: 'contracts',
          child: 'safeMathLib'
        }
      ],
    ...
    token: {
      ...
      txt: [
        {
          value: 'Token contract name: ',
          parent: 'none',
          fileValue: 'CrowdsaleTokenExt'
        },
        {
          field: 'addr',
    ...
    pricingStrategy: {
      ...
      txt: [
        {
          value: 'Pricing strategy contract name: ',
          parent: 'none',
          fileValue: 'FlatPricingExt'
        },
        {
          field: 'addr',
          value: 'Pricing strategy contract address',
          parent: 'contracts',
        ...
        },
        {
          field: 'abiConstructor',
          value:
            '****Pricing strategy contract ABI encoded constructor arguments',
          parent: 'contracts',
          child: 'pricingStrategy'
        }
      ],
    ...
    crowdsale: {
      ...
      txt: [
        {
          value: 'Crowdsale contract name: ',
          parent: 'none',
          fileValue: 'MintedTokenCappedCrowdsaleExt'
        },
        {
          field: 'addr',
          value: 'Crowdsale contract address',
          parent: 'contracts',
          child: 'crowdsale'
        },
        {
      ...
      sol: {
        field: 'src',
        value: '****Crowdsale contract source:**** \n\n',
        parent: 'contracts',
        child: 'crowdsale'
      }
    },
    nullFinalizeAgent: {
      ...
      txt: [
        {
          value: 'Null finalize agent contract name: ',
          parent: 'none',
          fileValue: 'NullFinalizeAgentExt'
        },
        {
          field: 'addr',
        ...
        },
        {
          field: 'abiConstructor',
          value:
            '****Null Finalize agent contract ABI encoded constructor arguments',
          parent: 'contracts',
          child: 'finalizeAgent'
        }
      ],
    ...
    finalizeAgent: {
      ...
      txt: [
        {
          value: 'Finalize agent contract name: ',
          parent: 'none',
          fileValue: 'ReservedTokensFinalizeAgent'
        },
        {
          field: 'addr',
          value: 'Finalize agent contract address',
          parent: 'contracts',
          child: 'finalizeAgent'
        },
        {
        ...
        },
        {
          field: 'abiConstructor',
          value:
            '****Finalize agent contract ABI encoded constructor arguments',
          parent: 'contracts',
          child: 'finalizeAgent'
        }
      ],
...
export const TOAST = {
  ...
  MESSAGE: {
    ...
    CONTRACT_DOWNLOAD_SUCCESS:
      'A file with contracts and metadata downloaded on your computer',
    FINALIZE_FAIL:
      'Was not able to finalize Crowdsale. Please be sure that Crowdsale has ended already',
